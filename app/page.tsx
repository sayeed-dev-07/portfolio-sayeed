  ...
  return (
    ...
    "
      ...
      <div ref={dividerRef} className="min-h-screen mt-[100vh]">
        <div className="relative z-6 -mb-px">
          <svg
            viewBox="0 0 1440 160"
            preserveAspectRatio="none"
            className="block h-[18vh] w-full sm:h-[20vh]"
          >
            <path
              d="
      M0,80
    ...
    "
        ...
        {/* rest of the page  */}
        <div id="AboutSection" className="relative z-6 -mt-px bg-[#e2d7a8]">
          ...
          <div className="relative z-6 min-h-screen overflow-hidden bg-[#e2d7a8]">
            <div ref={aboutMeSvgRef} className={`pointer-events-none absolute left-0 z-10 w-[52%] top-1 sm:w-[42%] sm:-top-4 md:w-[30%] md:-top-6 xl:w-[20%] ${aboutLogo ? 'rotate-10' : 'rotate-0'}`}>
